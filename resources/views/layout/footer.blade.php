<footer class="text-muted py-5 bg-dark text-white">
    <div class="container">
        ...
        <p class="mb-0">New to Bootstrap?
            ...
            or read our
            <a href="/docs/5.0/getting-started/introduction/" class="text-white text-decoration-none">getting started
                guide</a>.
        </p>
    </div>
</footer>
...
<style>
    ...
    footer .container {
        max-width: 990px;
        /* Restrict container width for better alignment */
    }
